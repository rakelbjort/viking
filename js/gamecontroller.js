	...
	exports.GameController = {
		...
		simulateKeyEvent: function( eventName, keyCode ) {
		    ...
		    if(eventObj.initEvent){
		      eventObj.initEvent("key" + eventName, true, true);
		    }
		  
    		eventObj.keyCode = keyCode;
    		eventObj.which = keyCode;
    
    		document.body.dispatchEvent ? document.body.dispatchEvent(eventObj) : document.body.fireEvent("onkey" + eventName, eventObj); 
